...
export const notifications: NotificationItem[] = [
  {
    ...
    message: "O fone Sony que você quer cabe no seu orçamento este mês.",
    time: "5 min",
    read: false,
    icon: "sparkles",
  },
  {
    ...
    message: "R$ 2.340,00 com vencimento em 14/07.",
    time: "2 h",
    read: false,
    icon: "credit-card",
  },
  {
    ...
    message: "Sua meta 'PC Gamer' está em 82%.",
    time: "1 d",
    read: false,
    icon: "target",
  },
  {
    id: "n4",
    category: "report",
    title: "Seu relatório de junho chegou",
    message: "Você economizou 36% da sua renda em junho.",
    time: "2 d",
    read: true,
    icon: "file-text",
  },
  {
    ...
    message: "Suas despesas com lazer subiram 24% este mês.",
    time: "3 d",
    read: true,
    icon: "triangle-alert",
  },
  {
    ...
    message: "Comprar o iPhone em outubro seria mais seguro.",
    time: "4 d",
    read: true,
    icon: "calculator",
  },
...
export const testimonials = [
  {
    name: "Mariana Silva",
    role: "Designer",
    text: "Finalmente entendi para onde vai meu dinheiro. O simulador me impede de fazer compras por impulso.",
    avatar: "MS",
  },
  {
    name: "Carlos Mendes",
    role: "Desenvolvedor",
    text: "A previsão de fluxo de caixa mudou como eu planejo minhas compras grandes. Simplesmente essencial.",
    avatar: "CM",
  },
  {
    name: "Ana Costa",
    role: "Empreendedora",
    text: "Interface linda e super fácil de usar. Consegui juntar minha reserva de emergência em 8 meses.",
    avatar: "AC",
  },
  {
    name: "Pedro Alves",
    role: "Estudante",
    text: "Como estudante, cada centavo conta. O Cofrinho me ajuda a decidir quando posso me dar um agrado.",
    avatar: "PA",
  },
];
